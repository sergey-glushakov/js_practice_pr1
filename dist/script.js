...
/* harmony default export */ __webpack_exports__["default"] = (forms); // разобрать еще раз работу fetch
...
var images = function images() {
  var imgPopup = document.createElement("div"); // создаю popup с показываемым изображением

  var workSection = document.querySelector(".works"); // общая секция с картинками

  var bigImage = document.createElement("img"); // большое изображение
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    // closeClickOverlay = true при клике на подложку по умолчанию закрывается модальное окно
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.overflow = "hidden"; // document.body.classList.add('modal-open') //modal-open класс из бутстрапа
      });
    });
    close.addEventListener("click", function () {
      ...
      document.body.style.overflow = ""; // document.body.classList.remove('modal-open') //modal-open класс из бутстрапа
    });
  ...
  function showModalByTime(selector, time) {
    // функция для показа всплывающего окна через интервал time
    setTimeout(function () {
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  var header = document.querySelector(headerSelector); // общий блок с кнопками табов

  var tab = document.querySelectorAll(tabSelector);
  var content = document.querySelectorAll(contentSelector); //const  header = document.querySelector(activeClass);
  ...
  function showTabContent() {
    var ndx = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
    content[ndx].style.display = display;
  ...
  header.addEventListener('click', function (e) {
    ...
    if (target && (target.classList.contains(tabSelector.replace(/\./, "")) || target.parentNode.classList.contains(tabSelector.replace(/\./, "")))) {
      // убираю точку в имени класса, приходящего в tabSelector 
      tab.forEach(function (item, ndx) {
...
var timer = function timer(id, deadline) {
  ...
  var getTimeRemaning = function getTimeRemaning(endtime) {
    ...
    var days = Math.floor(t / (1000 * 60 * 60 * 24)); //console.log(t);
